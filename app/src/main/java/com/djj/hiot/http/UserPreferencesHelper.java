...
public class UserPreferencesHelper {
    ...
    private static final String SP_USER_EMAIL_KEY = "SP_USER_EMAIL_KEY";//mail
    ...
    @Nullable
    public String getTokenValue(){ return mPreferences.getString(SP_USER_TOKENVALUE_KEY,null);}
    ...
    @Nullable
    public String getUuid(){ return mPreferences.getString(SP_USER_UUID_KEY,null);}
    ...
    @Nullable
    public String getUserName(){ return mPreferences.getString(SP_USER_NAME_KEY,null);}
    ...
    @Nullable
    public String getPassword(){ return mPreferences.getString(SP_USER_PASSWORD_KEY,null);}
    ...
    @Nullable
    public String getNickName(){ return mPreferences.getString(SP_USER_NICK_NAME_KEY,null);}
    ...
    @Nullable
    public String getUserEmail(){ return mPreferences.getString(SP_USER_EMAIL_KEY,null);}


    //清空持久化信息
    public void clear(){ mPreferences.edit().clear().apply();}
}
